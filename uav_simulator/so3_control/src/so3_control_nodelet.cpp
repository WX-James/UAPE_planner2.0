...
SO3ControlNodelet::onInit(void)
{
  ...
  n.param("/so3_control/gains/rot/x", kR_[0], 1.5);
  n.param("/so3_control/gains/rot/y", kR_[1], 1.5);
  n.param("/so3_control/gains/rot/z", kR_[2], 1.0);
  n.param("/so3_control/gains/ang/x", kOm_[0], 0.13);
  n.param("/so3_control/gains/ang/y", kOm_[1], 0.13);
  n.param("/so3_control/gains/ang/z", kOm_[2], 0.1);

  n.param("/so3_control/corrections/z", corrections_[0], 0.0);
  n.param("/so3_control/corrections/r", corrections_[1], 0.0);
  n.param("/so3_control/corrections/p", corrections_[2], 0.0);
